...
(function (global, factory) {
	...
	$(document).ready(function () {
		...
		$(".itemDot").click(function () {
			...
			$(".itemDot").removeClass("active1");
			$(this).addClass("active1");
			$(".CirItem").removeClass("active1");
			$(".CirItem" + dataTab).addClass("active1");
			i = dataTab;
		...
		// Disable transformation on small screen sizes
		$(window).resize(function () {
			if ($(window).width() < 599) {
				$(".dotCircle, .itemDot").css({
					transform: "none",
					transition: "none",
				});
			} else {
	...
	jQuery(".show").click(function (e) {
		...
		if (jQuery(this).parent().parent().hasClass("open")) {
			...
			for (let i = 0; i < items.length; i++) {
				...
				jQuery(items[i]).css(
					"transform",
					"translateY(calc(" + percentOffset + " - " + marginOffset + "))"
				);
			}
		}
	});
